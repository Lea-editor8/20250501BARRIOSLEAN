...
\begin{quote}
La noción de independencia arrastró estos últimos años una impugnación un tanto panfletaria y cansadora ---sin embargo necesaria--- desde el kirchnerismo, especialmente cuando se contrapuso a \enquote{independencia}\textbf{la desafortunada figura del periodismo militante}. A la idea de la independencia periodística se la puede cuestionar desde lo ideológico (``desde qué lugar hablás'') tanto como desde el punto de vista de la subordinación y obturación de la independencia dados los intereses y necesidades empresarias. Hay otro enfoque posible para deconstruir la noción de independencia que tiene que ver más con la esfera íntima del periodista (Blaustein, 2013: 122). \footnote{El énfasis es propio.}
\end{quote}
