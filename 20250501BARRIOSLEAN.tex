% referencias
\addbibresource{./files/gbTeXbib-20250501BARRIOSLEAN.bib}

% glosarios
\input{./files/gbTeXglo-20250501BARRIOSLEAN.tex}

\ifPDF
% separata de capítulos solo en pdf de pantalla
\input{./files/gbTeXseparata-20250501BARRIOSLEAN.tex}
...
\usepackage{hyperxmp}
\input{./files/gbTeXmeta-20250501BARRIOSLEAN.tex}
	\else
	\ifBNPDF
	\usepackage[width=18truecm,height=25.5truecm,cam,center]{crop}
	\newcommand*\infofont[1]{\sf{\footnotesize #1 (leandrobarriospintos90@gmail.com)}}
	\crop[font=infofont]
...
\emph{Esse est percipi}(Ser es ser percibido) Borges y Bioy Casares}
%\footnote{\fullcite{clave}}
...
\begin{quote}
Tengo la obligación de hacer una pregunta sobre~Clarín. Martín Sivak, que escribió el libro (Clarín, la era Magnetto), dice que \enquote{primera vez durante los años Kirchneristas~Clarín~cambió su forma de hacer política e hizo un~periodismo de guerra}. Escribió en 2014 que más allá de cómo termine el kirchnerismo, iba a ser difícil que~Clarín vuelva a tener la gravitación que tuvo en la sociedad argentina. Si es así, ¿cómo es el Clarín~de posguerra, cómo es el~Clarín~poskirchnerista o cuál es tu lectura?
\end{quote}
...
Dos ejes recorren con claridad el texto. El primero presenta algunos aspectos espectaculares de la vida de Jorge Lanata, sus intentos de suicidio, sus adicciones y su particular modo de vida con relación a sus parejas, hija y familia en general. El segundo eje recorre elementos de interés para una psicología del periodista, su vanidad y egocentrismo, excentricidades, despilfarro, etc. Casi no hay recuerdo de su paso por \emph{Página/12}, ni de su eventual relación con ex integrantes del Ejército Revolucionario del Pueblo (ERP). El libro fue un producto eminentemente publicitario a fin de re posicionar al personaje e introducirlo de manera no conflictiva en el \enquote{mundo Clarín}.
...
\begin{quote}
\enquote{Yo tenía 22 años \rdm{escribió el hoy canciller (en realidad, en 1977 cumplió 24)} y lo que más ansiaba era una intimidad normal con Anabel}. El espacio íntimo que podían compartir era el departamento de soltero de San Telmo, que, dijo, \enquote{había usado a menudo para ocultar disidentes}. (Levinas 2013: 70)
\end{quote}
...
Silvina Walger: Lo conocí cuando estaba en La Opinión. Yo estaba de novia con \enquote{el Vasco} Mouriño, lo conocí por él (\dots). Ya en Confirmado, \textbf{Horacio \enquote{olía a servicio}.} Hubo una época en que figuraba como "asesor de la dirección'' (Levinas, 2015: 418).\footnote{El énfasis es propio.}
